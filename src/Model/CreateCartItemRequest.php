...
/**
 * CreateCartItemRequest Class Doc Comment
 *
 * @category Class
 * @package  Platon\\ControlPanel\\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateCartItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createCartItem_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('process_type', $data ?? [], null);
     ...
     * Sets process_type
     *
     * @param string|null $process_type process_type
     *
     * @return self
     */
    public function setProcessType($process_type)
    {
        if (is_null($process_type)) {
            throw new \InvalidArgumentException('non-nullable process_type cannot be null');
        }
