...
/**
 * SpamDetection200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  Platon\\ControlPanel\\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class SpamDetection200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'spamDetection_200_response_data';
    ...
    public const CLASSIFICATION_SPAM = 'spam';
    public const CLASSIFICATION_HAM = 'ham';
    public const CLASSIFICATION_UNKNOWN = 'unknown';
    public const CLASSIFICATION_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    ...
    public function getClassificationAllowableValues()
    {
        return [
            ...
            self::CLASSIFICATION_HAM,
            self::CLASSIFICATION_UNKNOWN,
            self::CLASSIFICATION_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
     ...
     * Sets classification
     *
     * @param string $classification Normalized classification returned by the LLM.
     *
     * @return self
     */
    public function setClassification($classification)
    {
        ...
        if (!in_array($classification, $allowedValues, true)) {
            $classification = self::CLASSIFICATION_UNKNOWN_DEFAULT_OPEN_API;
        }
     ...
     * Sets confidence
     *
     * @param float $confidence Normalized confidence from 0 to 100.
     *
     * @return self
     */
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 100)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling SpamDetection200ResponseData., must be smaller than or equal to 100.');
        }
        if (($confidence < 0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling SpamDetection200ResponseData., must be bigger than or equal to 0.');
        }
     ...
     * Sets reason
     *
     * @param string $reason Short explanation in Slovak.
     *
     * @return self
     */
     ...
     * Sets signals
     *
     * @param string[] $signals Most important signals used for the classification.
     *
     * @return self
     */
     ...
     * Sets error
     *
     * @param bool $error True when the LLM call or response validation failed.
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string $error_message Short technical error reason. Raw LLM response is never returned here.
     *
     * @return self
     */
